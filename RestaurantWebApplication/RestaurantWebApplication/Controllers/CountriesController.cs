...
namespace RestaurantWebApplication.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public CountriesController(DBRestaurantsContext context)
        {
            _context = context;
        }
        ...
        {
            List<Tuple<Country, List<City>>> countriesWithCities = new List<Tuple<Country, List<City>>>();

            foreach(Country c in _context.Countries)
            {
                countriesWithCities.Add(new Tuple<Country, List<City>>(c, FindCities(c.CountryId)));
            }

            ViewBag.CountriesWithCities = countriesWithCities;
        ...
        public async Task<IActionResult> Create([Bind("CountryId,Name")] Country country)
        {
            ...
            {
                bool Valid = false;
                string ErrorMsg = "THIS COUNTRY ALREADY EXIST";
        ...
        public List<City> FindCities(int? countyID)
        {
            if (countyID == null)
                return null;
